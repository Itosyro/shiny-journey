...
function PaintClient.Init(remotesFolder)
	...
	local function updatePanelAvailability()
		...
		-- Hider, и в ОБЕИХ фазах (Hiding и Seeking - докраска во время
		-- поиска разрешена, см. DECISIONS.md, п.28); зеркалит серверную
		-- проверку в PaintService.onPaintStroke.
		local available = currentPhase == "Lobby"
